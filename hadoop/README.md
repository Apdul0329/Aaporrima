...
git clone https://github.com/psy337337/Aaporrima.git
```
...
1. **DataNode's ubuntu account password is not `ubuntu`**
    ...
    ```java
    ./Aaporrima/hadoop/1.sh (NameNode's ip address) (DataNode's ip address) (DataNode's ubuntu passwd) (DataNode's ip address) (DataNode's ubuntu passwd)...
    ```
    
    🔹Real Example
    
    ```java
    ./Aaporrima/hadoop/1.sh 10.0.20.157 10.0.20.180 ubuntu 10.0.20.181 ubuntu2
    ```
...
2. **DataNode's ubuntu account password is `ubuntu`**
    ...
    ```java
    ./Aaporrima/hadoop/v2.sh (NameNode's ip address) (DataNode's ip address) (DataNode's ip address)...
    ```
    
    🔹Real Example
    
    ```java
    ./Aaporrima/hadoop/v2.sh 10.0.20.157 10.0.20.180 10.0.20.181
    ```
